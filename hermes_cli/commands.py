...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    *_chatarch_command_defs(CommandDef),
    ...
    CommandDef("interrupt", "Interrupt the active run, or send the prompt normally when idle", "Session",
               ...
               busy_policy="dispatch", busy_handler="interrupt"),
...
#   - refine/review: review surfaces; reached through /hermes at the 50-cap.
#   - pause: global emergency stop; reached via /hermes pause [off].
#   - whoami/platform: lower-frequency identity/environment inspection.
#   - interrupt/compress-local: ChatArch control and emergency rescue surfaces.
#   - usage/insights/blueprint/cron: lower-frequency inspection and automation surfaces.
_SLACK_VIA_HERMES_ONLY = frozenset({
    "topup", "moa", "debug", "egress", "init", "version", "diff", "update",
    "heartbeat", "refine", "review", "pause", "whoami", "platform",
    "interrupt", "compress-local", "usage", "insights", "blueprint", "cron",
})
