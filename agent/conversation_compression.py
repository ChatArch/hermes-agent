...
def _supported_compression_kwargs(
    ...
    memory_context: str, bypass_cooldown: bool = False, local_fallback_only: bool = False,
) -> dict:
...
def _resolve_compress_call(
    ...
    bypass_cooldown: bool, local_fallback_only: bool = False,
...
def _run_summary_phase(
    ...
    attempt: _Attempt, local_fallback_only: bool = False,
) -> _SummaryPhase:
...
def compress_context(
    ...
    if getattr(agent, "api_mode", None) == "codex_app_server":
        if local_fallback_only:
            raise TypeError("codex_app_server does not support local_fallback_only")
        if checkpoint_required:
            raise _checkpoint_blocked(
    ...
    if not local_fallback_only and not getattr(agent, "_compression_feasibility_checked", False):
