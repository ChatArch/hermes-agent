        ...
        try:
            if self._message_id is not None:
                if self._edit_supported:
                    ...
                    # via fresh_final_preview_replacement_text. When an adapter
                    # exposes the hook and explicitly returns False, the time
                    # threshold must not override that decision (#47048).
                    if (
                        _needs_fresh_final
