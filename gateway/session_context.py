...
def set_session_vars(
    ...
    ``cron_session`` marks scheduler-owned agent turns. Normal gateway turns
    explicitly bind it false so a stale process-level HERMES_CRON_SESSION cannot
    leak from the scheduler into live user approvals.
    """
