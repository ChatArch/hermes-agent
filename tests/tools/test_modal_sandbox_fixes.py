...
class TestToolResolution:
    ...
    def test_terminal_and_file_toolsets_resolve_all_tools(self):
        """Terminal and file toolsets retain required tools across deferral policies."""
        ...
        required = {"terminal", "process_manage", "ssh_mode", "read_file", "write_file", "search_files", "patch"}
