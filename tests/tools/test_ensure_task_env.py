...
def test_session_ssh_override_beats_global_local_backend(monkeypatch):
    """Lazy bring-up must apply section/session overrides before local no-op."""
    monkeypatch.setenv("TERMINAL_ENV", "local")
    task_id = "t-section-ssh"
