...
@pytest.mark.asyncio
async def test_feishu_thread_launcher_keeps_seed_out_of_agent_output_flow():
    """/t creates a Feishu topic but keeps the agent turn as normal linear chat."""
    ...
    assert dispatched_event.source.message_id == "om_command"
