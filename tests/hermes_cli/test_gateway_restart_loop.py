...
class TestGatewaySelfTargetingGuard:
    ...
    def test_restart_refuses_before_self_request_in_actual_gateway(
        self, monkeypatch
    ):
        """The supervised gateway itself is not a hosted CLI descendant."""
        from tools import process_registry
        ...
        monkeypatch.setattr(
            gw,
            "_request_current_gateway_self_restart",
            lambda: pytest.fail("actual gateway must not self-signal here"),
        )
