...
DEFAULT_DB_PATH = _IMPORT_DEFAULT_DB_PATH = Path(get_hermes_home()) / "state.db"
...
def _default_db_path() -> Path:
    """Resolve the profile DB at call time unless the default was explicitly overridden."""
    return DEFAULT_DB_PATH if DEFAULT_DB_PATH != _IMPORT_DEFAULT_DB_PATH else Path(get_hermes_home()) / "state.db"
