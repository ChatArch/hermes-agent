...
_HERMES_CORE_TOOLS = [
    ...
    "terminal", "process_manage", "ssh_mode",
...
TOOLSETS = {
    ...
    "terminal": _ts("Terminal/command execution and process management tools", ["terminal", "process_manage", "ssh_mode"]),
    "skills": _ts(
    ...
    "debugging": _ts("Debugging and troubleshooting toolkit", [], includes=["terminal", "web", "file"]),
