...
LEGACY_AUTHOR_MAP = {
    ...
    'gigakun@agentmail.to': 'gigakun3030',  # ChatArch legacy mapping retained during official sync
    'jakub.wolniewicz@gmail.com': 'jakub-wolniewicz',  # ChatArch legacy mapping retained during official sync
    'markvlcek@gmail.com': 'markvlcek',  # ChatArch legacy mapping retained during official sync
